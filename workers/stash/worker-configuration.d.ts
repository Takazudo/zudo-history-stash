/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/stash/wrangler.toml --include-runtime=false workers/stash/worker-configuration.d.ts` (hash: 57ef39a0d497b2b19bba8e11b906255d)
