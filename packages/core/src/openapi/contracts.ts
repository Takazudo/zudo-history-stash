...
export const ROUTE_CONTRACTS = {
  ...
  createCommit: {
    ...
    description: "Atomically applies one or more file entries.",
    ...
    responses: {
      201: response("The committed entries.", "CommitResult", "CommitResult", [
        "Idempotent-Replayed",
      ]),
    },
    errors: [
  ...
  getCommit: {
    ...
    description: "Returns a commit and its entries.",
    principalNote: "read; administrator or a matching read/write stash token.",
    responses: { 200: response("The commit record.", "CommitRecord", "CommitRecord") },
    errors: [error("validation"), error("unauthorized"), error("not-found"), rateLimited()],
    wildcardPath: false,
  },
  listCommits: {
    summary: "List commits",
    description: "Returns commits newest first.",
    principalNote: "read; administrator or a matching read/write stash token.",
    query: ListCommitsQuery,
    responses: { 200: response("A page of commits.", "CommitListResponse", "CommitListResponse") },
    errors: [error("validation"), error("unauthorized"), error("not-found"), rateLimited()],
    wildcardPath: false,
  },
  getCommitDiff: {
    summary: "Get a commit diff",
    description: "Returns per-entry diffs for a commit.",
    principalNote: "read; administrator or a matching read/write stash token.",
    query: CommitDiffQuery,
    responses: { 200: response("The commit diff.", "CommitDiffResult", "CommitDiffResult") },
    errors: [
      error("validation"),
      error("unauthorized"),
      error("not-found"),
  ...
  revertCommit: {
    ...
    requestHeaders: ["Idempotency-Key", STASH_CLIENT_ID_HEADER],
    responses: {
      201: response("The revert commit.", "CommitResult", "CommitResult", ["Idempotent-Replayed"]),
    },
    errors: [
      error("validation"),
      error("unauthorized"),
  ...
  getSnapshot: {
    ...
    description: "Lists files as of a commit.",
    principalNote: "read; administrator or a matching read/write stash token.",
    query: SnapshotQuery,
    responses: { 200: response("The snapshot page.", "SnapshotResponse", "SnapshotResponse") },
    errors: [error("validation"), error("unauthorized"), error("not-found"), rateLimited()],
    wildcardPath: false,
  },
  createChangeSet: {
    summary: "Create a change set",
    description: "Stores an expiring multi-file candidate.",
    principalNote: "write; administrator or a matching write stash token.",
    body: CreateChangeSetBody,
    requestHeaders: ["Idempotency-Key", STASH_CLIENT_ID_HEADER],
    responses: {
      201: response("The change set.", "ChangeSetRecord", "ChangeSetRecord", [
        "Idempotent-Replayed",
      ]),
    },
    errors: [
  ...
  listChangeSets: {
    ...
    description: "Returns filtered change sets newest first.",
    principalNote: "read; administrator or a matching read/write stash token.",
    query: ListChangeSetsQuery,
    responses: {
      200: response("A page of change sets.", "ChangeSetListResponse", "ChangeSetListResponse"),
    },
    errors: [error("validation"), error("unauthorized"), error("not-found"), rateLimited()],
    wildcardPath: false,
  },
  getChangeSet: {
    ...
    description: "Returns a change set and current staleness.",
    principalNote: "read; administrator or a matching read/write stash token.",
    responses: { 200: response("The change set.", "ChangeSetRecord", "ChangeSetRecord") },
    errors: [error("validation"), error("unauthorized"), error("not-found"), rateLimited()],
    wildcardPath: false,
  },
  getChangeSetDiff: {
    summary: "Get a change-set diff",
    description: "Returns candidate and current diffs.",
    principalNote: "read; administrator or a matching read/write stash token.",
    query: ChangeSetDiffQuery,
    responses: {
      200: response("The change-set diff.", "ChangeSetDiffResult", "ChangeSetDiffResult"),
    },
    errors: [
      error("validation"),
      error("unauthorized"),
  ...
  approveChangeSet: {
    ...
    description: "Atomically applies an open, current change set.",
    principalNote: "write; administrator or a matching write stash token.",
    body: ApproveChangeSetBody,
    requestHeaders: [STASH_CLIENT_ID_HEADER],
    responses: {
      200: response("The applied commit.", "ApproveChangeSetResult", "ApproveChangeSetResult"),
    },
    errors: [
      error("validation"),
      error("unauthorized"),
      ...
      error("not-found"),
      error("commit-conflict"),
      error("change-set-expired"),
      error("change-set-closed"),
      error("payload-too-large"),
      rateLimited(),
      error("internal"),
    ],
  ...
  rejectChangeSet: {
    summary: "Reject a change set",
    description: "Rejects an open change set.",
    principalNote: "write; administrator or a matching write stash token.",
    body: RejectChangeSetBody,
    requestHeaders: [STASH_CLIENT_ID_HEADER],
    responses: {
      200: response("The rejected change set.", "ChangeSetRecord", "RejectedChangeSetRecord"),
    },
    errors: [
      error("validation"),
      error("unauthorized"),
