...
export const ROUTES = [
  ...
  { id: "listGcRuns", method: "GET", template: "/v1/admin/gc/runs", principal: "admin" },
  {
    id: "createCommit",
    method: "POST",
    template: "/v1/stashes/:stash/commits",
    principal: "write",
  },
  ...
  { id: "listCommits", method: "GET", template: "/v1/stashes/:stash/commits", principal: "read" },
  {
    id: "getCommitDiff",
    method: "GET",
    template: "/v1/stashes/:stash/commits/:id/diff",
    principal: "read",
  },
  {
    id: "revertCommit",
    method: "POST",
    template: "/v1/stashes/:stash/commits/:id/revert",
    principal: "write",
  },
  { id: "getSnapshot", method: "GET", template: "/v1/stashes/:stash/snapshot", principal: "read" },
  {
    id: "createChangeSet",
    method: "POST",
    template: "/v1/stashes/:stash/change-sets",
    principal: "write",
  },
  {
    id: "listChangeSets",
  ...
  },
  {
    id: "getChangeSet",
    method: "GET",
    template: "/v1/stashes/:stash/change-sets/:id",
    principal: "read",
  },
  {
    id: "getChangeSetDiff",
    method: "GET",
    template: "/v1/stashes/:stash/change-sets/:id/diff",
    principal: "read",
  },
  {
    id: "approveChangeSet",
    method: "POST",
    template: "/v1/stashes/:stash/change-sets/:id/approve",
    principal: "write",
  },
  {
    id: "rejectChangeSet",
    method: "POST",
    template: "/v1/stashes/:stash/change-sets/:id/reject",
    principal: "write",
  },
  {
    id: "stashEvents",
