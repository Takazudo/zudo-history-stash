        ...
        async (body, idempotencyKey) =>
          (await call(
            ...
            target(route("putFile", stash, path)),
            {
              ...
              ...(uploadOptions.author === undefined ? {} : { author: uploadOptions.author }),
              ...(uploadOptions.message === undefined ? {} : { message: uploadOptions.message }),
              ...(uploadOptions.meta === undefined ? {} : { meta: uploadOptions.meta }),
            },
            idempotencyKey,
          )) as ClientResult<PutResult>,
      );
